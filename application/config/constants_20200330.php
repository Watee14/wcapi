...
defined('_MAP_SEARCH') 		OR define('_MAP_SEARCH', 	"https://api.longdo.com/mapsearch/json/search");
...
defined('_MAP_KEY')			OR define('_MAP_KEY',		"020c684581828b182cbf82ee531eb4b9"); 
...
|
*/
defined('_M_SERVICE') OR define('_M_SERVICE', 'http://10.0.106.66/191ws/');
...
defined('_SMH_LINE') 		OR define('_SMH_LINE', getcwd().'/../smhLine');