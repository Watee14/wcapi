...
defined('_MAP_ADDRESS') 	OR define('_MAP_ADDRESS',		"http://192.168.101.63/map2/services/address");
...
//defined('_MAP_SERVER') 	OR define('_MAP_SERVER',		"http://192.168.101.63/map2/");
defined('_MAP_SERVER') 		OR define('_MAP_SERVER',		$protocol."://192.168.101.63/map2/");
...
defined('_M_SERVICE') OR define('_M_SERVICE', 'https://aml.welcomedcc.com/191ws/');
...
//defined('HEX_AUTHEN_TOKEN') 		OR define('HEX_AUTHEN_TOKEN', 'https://hex-oncall.191poc.local/oncall.identity/connect/token');
defined('HEX_AUTHEN_TOKEN') 		OR define('HEX_AUTHEN_TOKEN', 'https://hex.welcomedcc.com/oncall.identity/connect/token');
...
//defined('HEX_TOKEN_START') 		OR define('HEX_TOKEN_START', 'http://hex-oncall.191poc.local:8080/api/StartSession');
//defined('HEX_TOKEN_START') 		OR define('HEX_TOKEN_START', 'http://hex-wa-dc2.191poc.local:8080/api/StartSession');
defined('HEX_TOKEN_START') 		OR define('HEX_TOKEN_START', 'http://192.168.101.9:8080/api/StartSession');
//defined('HEX_SERVICE') 		OR define('HEX_SERVICE', 'http://hex-oncall.191poc.local:8000/api/v1');
//defined('HEX_SERVICE') 		OR define('HEX_SERVICE', 'http://hex-oncall.191poc.local:8080/api/v1');
//defined('HEX_SERVICE') 		OR define('HEX_SERVICE', 'http://hex-wa-dc2.191poc.local:8080/api/v1');
defined('HEX_SERVICE') 		OR define('HEX_SERVICE', 'http://192.168.101.9:8080/api/v1');

defined('CAD_APP') 		OR define('CAD_APP', 'http://192.168.101.16:8008/callback');

defined('HEX_CONFIG_PATH') 		OR define('HEX_CONFIG_PATH', 'http://192.168.101.16:8008/callback');
