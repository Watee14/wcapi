...
class Lbs extends CI_Controller{
	...
	public function test(){
		try{
			$url=[];
			$url[0]='https://demosrv-gws.genesyslab.com/api/v2/contacts?fields=*&offset=0&limit=100';
			$url[1]='https://demosrv-gws.genesyslab.com/api/v2/diagnostics/version';
			$url[2]='https://demosrv-gws.genesyslab.com/api/v2/groups?fields=*';
			$url[3]='https://demosrv-gws.genesyslab.com/api/v2/places?fields=*';
			$url[4]='https://demosrv-gws.genesyslab.com/api/v2/platform/configuration/access-groups';
			$url[5]='https://demosrv-gws.genesyslab.com/api/v2/platform/configuration/agent-logins';
			$url[6]='https://demosrv-gws.genesyslab.com/api/v2/platform/configuration/skills';
			$url[7]='https://demosrv-gws.genesyslab.com/api/v2/platform/configuration/persons';
			$url[8]='https://demosrv-gws.genesyslab.com/api/v2/skills?fields=*';
			$result=(array)json_decode($this->curl_services($url[5],'{}','GET'),TRUE);
			echo json_encode($result);
		}
		catch(Exception $e){
			echo json_encode([]);
