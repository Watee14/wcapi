        ...
        function OutOfArea( desc ) {
         ...
         console.log( oTime );
          $.ajax({
            ...
            data: { lat : desc['police_vehicle_lat'] , lon : desc['police_vehicle_lon'] , device_name : desc['device_name'] , bearing : '-1' , break_duration : oTime , police_vehicle_name : desc['police_vehicle_number'] , police_station_code : desc['police_station_code'] , message : 'รถสายตรวจออกนอกพื้นที่' }
          }).done(function(data) {
