...
<script>
      var base_url = "<?php echo base_url();?>";
        ...
        function OutOfArea( desc ) {
         ...
         var oTime = (new Date().getTime() - outAreaTime)  ;
         console.log( oTime );
          $.ajax({
            url: "<?php echo base_url(); ?>Mdu_map/outOfArea/"  ,
            data: { lat : desc['police_vehicle_lat'] , lon : desc['police_vehicle_lon'] , device_name : desc['device_name'] , bearing : '-1' , break_duration : oTime , police_vehicle_name : desc['police_vehicle_number'] , police_vehicle_code : desc['police_vehicle_code']  , police_station_code : desc['police_station_code'] , message : 'รถสายตรวจออกนอกพื้นที่' }
          }).done(function(data) {
